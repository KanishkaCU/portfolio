      ...
      <div className="container hero-inner">
        ...
        <div className="hero-left">
          ...
          <div className="hero-actions fade-in" style={{ animationDelay: "0.6s" }}>
            <a href="https://github.com/YOUR_USERNAME" target="_blank" rel="noreferrer" className="btn-github">
            ...
            <a href="https://linkedin.com/in/YOUR_PROFILE" target="_blank" rel="noreferrer" className="btn-linkedin">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
